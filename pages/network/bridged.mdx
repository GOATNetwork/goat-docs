...
The GOAT Network Bridge enables secure asset transfers between Bitcoin (L1) and GOAT Network (L2) through GOAT BitVM2 Bridge Protocol. This guide will walk you through the bridging process step by step.
...
- Automatic dispute resolution through GOAT BitVM2

## Technical Details

For developers interested in bridge integration:
- [Bridge Technical Specification](/introduction/bridge)
- [Security Model Documentation](/introduction/security)
