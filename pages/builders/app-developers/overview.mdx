...
lang: en-US
description: Start building decentralized applications with ease on the GOAT Network.
---

# App Developer Overview

Welcome to the **GOAT Network App Developer Documentation**! This guide is your starting point for developing decentralized applications (dApps) on **GOAT Network**, a secure, efficient, and developer-friendly blockchain network.
...
- **GOAT Network RPC Endpoint**: `https://rpc.goat.network` for Alpha Mainnet, `https://rpc.testnet3.goat.network` for Testnet3
- **Chain ID**: `2345` for Alpha Mainnet, `48816` for Testnet3
- **Network Name**: `GOAT Network` for Alpha Mainnet, `GOAT Testnet3` for Testnet3
...
2. Fill in the following details:
   ...
   - **RPC URL**: `https://rpc.testnet3.goat.network` or `https://rpc.ankr.com/goat_testnet`
...
- **Technical Documentation**:
  - [Technical Whitepaper](https://www.goat.network/bitvm2-whitepaper)
...
- **Developer Forums**: Engage with fellow developers on our [Developer Chat](https://t.me/+He2b1t9Bh2ZiMzZh).
