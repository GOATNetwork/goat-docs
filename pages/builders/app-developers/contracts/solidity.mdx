...
```bash
npx hardhat run scripts/deploy.js --network goat-testnet3
```
...
| WrappedBtc.sol             | [`0xEE4bC42157cf65291Ba2FE839AE127e3Cc76f741`](https://explorer.testnet3.goat.network/address/0xEE4bC42157cf65291Ba2FE839AE127e3Cc76f741) | Wrapped BTC implementation                           |
