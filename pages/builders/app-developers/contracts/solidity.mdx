...
lang: en-US
description: Learn how to develop and deploy Solidity smart contracts on GOAT Network Testnet3.
---
...
```bash
npx hardhat run scripts/deploy.js --network goat-mainnet
```
...
### Alpha Mainnet Core Contracts
| Contract Name | Address | Description |
|--------------|---------|-------------|
| WGBTC | [`0xbC10000000000000000000000000000000000000`](https://explorer.goat.network/address/0xbC10000000000000000000000000000000000000) | Native wrapped Bitcoin token |
| Bridge | [`0xBC10000000000000000000000000000000000003`](https://explorer.goat.network/address/0xBC10000000000000000000000000000000000003) | Cross-chain bridge |
| Locking | [`0xbC10000000000000000000000000000000000004`](https://explorer.goat.network/address/0xbC10000000000000000000000000000000000004) | Token locking mechanism |
