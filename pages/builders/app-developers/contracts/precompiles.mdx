...
The developers are able to use [SPV](https://bitcoinwiki.org/wiki/simplified-payment-verification) directly by the method [newBlockHash](https://github.com/GOATNetwork/goat-contracts/blob/main/contracts/bitcoin/Bitcoin.sol#L23-L30) in smart contract [BitcoinBlocks.sol](http://localhost:3000/network/contracts#pre-deployed-contracts).
