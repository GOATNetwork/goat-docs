...
# Running a GOAT Testnet3 and Alpha Mainnet Sequencer Node
...
The software requirements refer to [Software Environment](/builders/sequencers/validator#software-environment).
...
```yaml:pages/builders/sequencers/running.mdx
