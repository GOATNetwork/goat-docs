...
<Callout type="warning">
  This guide is for running a Sequencer Node Operator position (like Goat.Network, Amber, Metis), which requires a 100 BTC security deposit and special permissions. For running a Sequencer Node (similar to Bitcoin mining) which requires 0.5 BTC, see [Running a Sequencer Node](/builders/sequencers/validator).
</Callout>

## Pre-requisites
Before you can run as a Sequencer Node Operator, you need to meet the following pre-requisites:
...
4. Have the technical expertise to run and maintain a Sequencer Operation
