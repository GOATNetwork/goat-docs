...
# Running a GOAT Sequencer Operator

<Callout type="warning">
  This guide is for running a Sequencer Node **Operator** position (like Goat.Network, Amber, Metis), which requires a 2 BTC security deposit and special permissions. For running a Sequencer Node (similar to Bitcoin mining) which requires 2 BTC, see [Running a Sequencer Node](/builders/sequencers/validator).
</Callout>
