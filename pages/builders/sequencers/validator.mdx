...
description: Complete guide for setting up and running a Sequencer Node (2 BTC lock) on GOAT Testnet3 and Alpha Mainnet
---
...
| **Archive Node**        | [https://archive.goat.network](https://archive.goat.network)          |
| **Chain ID**            | 2345                                                                    |
| **Currency Symbol**     | BTC                                                                     |
| **Currency Decimal**    | 18                                                                      |
| **Block Explorer**      | [https://explorer.goat.network](https://explorer.goat.network)         |
| **Gist**                | [Releases](https://github.com/GOATNetwork/goat/blob/main/docker/mainnet.yaml)      |
...
| **Gist**                | [Releases](https://github.com/GOATNetwork/goat/blob/main/docker/testnet3.yaml)      |
...
Fetch the `docker-compose.yml` of latest version from the Gist, [Testnet3](https://github.com/GOATNetwork/goat/blob/main/docker/testnet3.yaml) or [Alpha Mainnet](https://github.com/GOATNetwork/goat/blob/main/docker/mainnet.yaml);
...
- [Telegram](https://t.me/+He2b1t9Bh2ZiMzZh)
