...
<Callout type="info">
For the sake of clarity and to prevent any confusion, a sequencer node serves as the validator in this tutorial. The term "validator" is employed from the perspective of the decentralized network, whereas "sequencer node" is utilized from the perspective of the Bitcoin Layer 2 (L2) framework.
</Callout>
