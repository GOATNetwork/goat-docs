...
This guide is intended for all users preparing to claim the **GOATED token airdrop** on GOAT Network. It covers **Community Airdrop**, **Kaito Airdrop**, and Developer Airdrop (coming soon), including eligibility criteria, timelines, and claim procedures. Please read carefully to ensure a smooth process. During the first 24 hours after the start of available claims, only **OKX Wallet** users may execute claims. Airdrop participants using any other wallet must wait until **Sept 28, 10 AM (UTC)** to claim.
...
### 2. Day 1 — OKX Exclusive Claim (Sept 27–28, 10 AM UTC)

- Day 1 is exclusive to **OKX Wallet**.
...
### 3. Day 2 — Public Claim (From Sept 28, 10 AM UTC)

- All **EVM-compatible wallets** can claim.
- Same flow as above.
- Already claimed → **"Already received"** with balance.  
- After 90 days → **"END — Claim window is now closed."**
...
Within 48 hours before TGE, use OKX Wallet on Checker page. After 24 hours, other wallets (MetaMask, Bitget, WalletConnect) can also check.
...
- **First 24 hours**: Only OKX Wallet.  
- **Next 90 days**: All supported wallets.  
- **After 90 days**: Returned to Treasury.
